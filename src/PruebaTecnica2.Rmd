...
library(knitr)
library(writexl)
setwd("Prueba_T-cnica-GRAI-JEP")
knitr::opts_knit$set("Prueba_T-cnica-GRAI-JEP")
```
...
A<-read_excel("Prueba_T-cnica-GRAI-JEP/input/A.xlsx")
B<-read_excel("Prueba_T-cnica-GRAI-JEP/input/B.xlsx")
